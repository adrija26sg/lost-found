...
client = pymongo.MongoClient("mongodb+srv://adrija26sg:IYwLU2hVj83lKJRT@lostandfound.6rhyi.mongodb.net/?retryWrites=true&w=majority&appName=lostandfound", connect=False)
